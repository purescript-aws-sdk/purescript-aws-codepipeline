...
acknowledgeJob = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "acknowledgeJob"
...
acknowledgeThirdPartyJob = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "acknowledgeThirdPartyJob"
...
createCustomActionType = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "createCustomActionType"
...
deleteCustomActionType = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "deleteCustomActionType"
...
disableStageTransition = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "disableStageTransition"


-- | <p>Enables artifacts in a pipeline to transition to a stage in a pipeline.</p>
enableStageTransition :: forall eff. EnableStageTransitionInput -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
enableStageTransition = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "enableStageTransition"
...
getJobDetails = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "getJobDetails"
...
getPipeline = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "getPipeline"
...
getPipelineExecution = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "getPipelineExecution"
...
getPipelineState = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "getPipelineState"
...
getThirdPartyJobDetails = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "getThirdPartyJobDetails"
...
listActionTypes = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "listActionTypes"
...
listPipelineExecutions = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "listPipelineExecutions"
...
pollForJobs = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "pollForJobs"
...
pollForThirdPartyJobs = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "pollForThirdPartyJobs"
...
putActionRevision = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putActionRevision"
...
putApprovalResult = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putApprovalResult"
...
putJobFailureResult = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putJobFailureResult"
...
putJobSuccessResult = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putJobSuccessResult"
...
putThirdPartyJobFailureResult = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putThirdPartyJobFailureResult"
...
putThirdPartyJobSuccessResult = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "putThirdPartyJobSuccessResult"
...
retryStageExecution = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "retryStageExecution"
...
startPipelineExecution = Request.request service method  where
    service = Request.ServiceName "CodePipeline"
    method = Request.MethodName "startPipelineExecution"
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAcknowledgeJobOutput' :: ( { "status" :: NullOrUndefined.NullOrUndefined (JobStatus) } -> {"status" :: NullOrUndefined.NullOrUndefined (JobStatus) } ) -> AcknowledgeJobOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAcknowledgeThirdPartyJobOutput' :: ( { "status" :: NullOrUndefined.NullOrUndefined (JobStatus) } -> {"status" :: NullOrUndefined.NullOrUndefined (JobStatus) } ) -> AcknowledgeThirdPartyJobOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionConfiguration' :: ( { "configuration" :: NullOrUndefined.NullOrUndefined (ActionConfigurationMap) } -> {"configuration" :: NullOrUndefined.NullOrUndefined (ActionConfigurationMap) } ) -> ActionConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionConfigurationProperty' :: Boolean -> ActionConfigurationKey -> Boolean -> Boolean -> ( { "name" :: (ActionConfigurationKey) , "required" :: (Boolean) , "key" :: (Boolean) , "secret" :: (Boolean) , "queryable" :: NullOrUndefined.NullOrUndefined (Boolean) , "description" :: NullOrUndefined.NullOrUndefined (Description) , "type" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyType) } -> {"name" :: (ActionConfigurationKey) , "required" :: (Boolean) , "key" :: (Boolean) , "secret" :: (Boolean) , "queryable" :: NullOrUndefined.NullOrUndefined (Boolean) , "description" :: NullOrUndefined.NullOrUndefined (Description) , "type" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyType) } ) -> ActionConfigurationProperty
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionContext' :: ( { "name" :: NullOrUndefined.NullOrUndefined (ActionName) } -> {"name" :: NullOrUndefined.NullOrUndefined (ActionName) } ) -> ActionContext
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionDeclaration' :: ActionTypeId -> ActionName -> ( { "name" :: (ActionName) , "actionTypeId" :: (ActionTypeId) , "runOrder" :: NullOrUndefined.NullOrUndefined (ActionRunOrder) , "configuration" :: NullOrUndefined.NullOrUndefined (ActionConfigurationMap) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (OutputArtifactList) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (InputArtifactList) , "roleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) } -> {"name" :: (ActionName) , "actionTypeId" :: (ActionTypeId) , "runOrder" :: NullOrUndefined.NullOrUndefined (ActionRunOrder) , "configuration" :: NullOrUndefined.NullOrUndefined (ActionConfigurationMap) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (OutputArtifactList) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (InputArtifactList) , "roleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) } ) -> ActionDeclaration
...
newtype ActionExecution = ActionExecution 
  ...
  , "lastStatusChange" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionExecution' :: ( { "status" :: NullOrUndefined.NullOrUndefined (ActionExecutionStatus) , "summary" :: NullOrUndefined.NullOrUndefined (ExecutionSummary) , "lastStatusChange" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "token" :: NullOrUndefined.NullOrUndefined (ActionExecutionToken) , "lastUpdatedBy" :: NullOrUndefined.NullOrUndefined (LastUpdatedBy) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) , "externalExecutionUrl" :: NullOrUndefined.NullOrUndefined (Url) , "percentComplete" :: NullOrUndefined.NullOrUndefined (Percentage) , "errorDetails" :: NullOrUndefined.NullOrUndefined (ErrorDetails) } -> {"status" :: NullOrUndefined.NullOrUndefined (ActionExecutionStatus) , "summary" :: NullOrUndefined.NullOrUndefined (ExecutionSummary) , "lastStatusChange" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "token" :: NullOrUndefined.NullOrUndefined (ActionExecutionToken) , "lastUpdatedBy" :: NullOrUndefined.NullOrUndefined (LastUpdatedBy) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) , "externalExecutionUrl" :: NullOrUndefined.NullOrUndefined (Url) , "percentComplete" :: NullOrUndefined.NullOrUndefined (Percentage) , "errorDetails" :: NullOrUndefined.NullOrUndefined (ErrorDetails) } ) -> ActionExecution
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionState' :: ( { "actionName" :: NullOrUndefined.NullOrUndefined (ActionName) , "currentRevision" :: NullOrUndefined.NullOrUndefined (ActionRevision) , "latestExecution" :: NullOrUndefined.NullOrUndefined (ActionExecution) , "entityUrl" :: NullOrUndefined.NullOrUndefined (Url) , "revisionUrl" :: NullOrUndefined.NullOrUndefined (Url) } -> {"actionName" :: NullOrUndefined.NullOrUndefined (ActionName) , "currentRevision" :: NullOrUndefined.NullOrUndefined (ActionRevision) , "latestExecution" :: NullOrUndefined.NullOrUndefined (ActionExecution) , "entityUrl" :: NullOrUndefined.NullOrUndefined (Url) , "revisionUrl" :: NullOrUndefined.NullOrUndefined (Url) } ) -> ActionState
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionType' :: ActionTypeId -> ArtifactDetails -> ArtifactDetails -> ( { "id" :: (ActionTypeId) , "settings" :: NullOrUndefined.NullOrUndefined (ActionTypeSettings) , "actionConfigurationProperties" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyList) , "inputArtifactDetails" :: (ArtifactDetails) , "outputArtifactDetails" :: (ArtifactDetails) } -> {"id" :: (ActionTypeId) , "settings" :: NullOrUndefined.NullOrUndefined (ActionTypeSettings) , "actionConfigurationProperties" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyList) , "inputArtifactDetails" :: (ArtifactDetails) , "outputArtifactDetails" :: (ArtifactDetails) } ) -> ActionType
...
--   This may be useful if you need to immediately overwrite some of the optional values
newActionTypeSettings' :: ( { "thirdPartyConfigurationUrl" :: NullOrUndefined.NullOrUndefined (Url) , "entityUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) , "executionUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) , "revisionUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) } -> {"thirdPartyConfigurationUrl" :: NullOrUndefined.NullOrUndefined (Url) , "entityUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) , "executionUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) , "revisionUrlTemplate" :: NullOrUndefined.NullOrUndefined (UrlTemplate) } ) -> ActionTypeSettings
...
--   This may be useful if you need to immediately overwrite some of the optional values
newArtifact' :: ( { "name" :: NullOrUndefined.NullOrUndefined (ArtifactName) , "revision" :: NullOrUndefined.NullOrUndefined (Revision) , "location" :: NullOrUndefined.NullOrUndefined (ArtifactLocation) } -> {"name" :: NullOrUndefined.NullOrUndefined (ArtifactName) , "revision" :: NullOrUndefined.NullOrUndefined (Revision) , "location" :: NullOrUndefined.NullOrUndefined (ArtifactLocation) } ) -> Artifact
...
--   This may be useful if you need to immediately overwrite some of the optional values
newArtifactLocation' :: ( { "type" :: NullOrUndefined.NullOrUndefined (ArtifactLocationType) , "s3Location" :: NullOrUndefined.NullOrUndefined (S3ArtifactLocation) } -> {"type" :: NullOrUndefined.NullOrUndefined (ArtifactLocationType) , "s3Location" :: NullOrUndefined.NullOrUndefined (S3ArtifactLocation) } ) -> ArtifactLocation
...
--   This may be useful if you need to immediately overwrite some of the optional values
newArtifactRevision' :: ( { "name" :: NullOrUndefined.NullOrUndefined (ArtifactName) , "revisionId" :: NullOrUndefined.NullOrUndefined (Revision) , "revisionChangeIdentifier" :: NullOrUndefined.NullOrUndefined (RevisionChangeIdentifier) , "revisionSummary" :: NullOrUndefined.NullOrUndefined (RevisionSummary) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "revisionUrl" :: NullOrUndefined.NullOrUndefined (Url) } -> {"name" :: NullOrUndefined.NullOrUndefined (ArtifactName) , "revisionId" :: NullOrUndefined.NullOrUndefined (Revision) , "revisionChangeIdentifier" :: NullOrUndefined.NullOrUndefined (RevisionChangeIdentifier) , "revisionSummary" :: NullOrUndefined.NullOrUndefined (RevisionSummary) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "revisionUrl" :: NullOrUndefined.NullOrUndefined (Url) } ) -> ArtifactRevision
...
--   This may be useful if you need to immediately overwrite some of the optional values
newArtifactStore' :: ArtifactStoreLocation -> ArtifactStoreType -> ( { "type" :: (ArtifactStoreType) , "location" :: (ArtifactStoreLocation) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } -> {"type" :: (ArtifactStoreType) , "location" :: (ArtifactStoreLocation) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } ) -> ArtifactStore
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateCustomActionTypeInput' :: ActionCategory -> ArtifactDetails -> ArtifactDetails -> ActionProvider -> Version -> ( { "category" :: (ActionCategory) , "provider" :: (ActionProvider) , "version" :: (Version) , "settings" :: NullOrUndefined.NullOrUndefined (ActionTypeSettings) , "configurationProperties" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyList) , "inputArtifactDetails" :: (ArtifactDetails) , "outputArtifactDetails" :: (ArtifactDetails) } -> {"category" :: (ActionCategory) , "provider" :: (ActionProvider) , "version" :: (Version) , "settings" :: NullOrUndefined.NullOrUndefined (ActionTypeSettings) , "configurationProperties" :: NullOrUndefined.NullOrUndefined (ActionConfigurationPropertyList) , "inputArtifactDetails" :: (ArtifactDetails) , "outputArtifactDetails" :: (ArtifactDetails) } ) -> CreateCustomActionTypeInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreatePipelineOutput' :: ( { "pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) } -> {"pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) } ) -> CreatePipelineOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newErrorDetails' :: ( { "code" :: NullOrUndefined.NullOrUndefined (Code) , "message" :: NullOrUndefined.NullOrUndefined (Message) } -> {"code" :: NullOrUndefined.NullOrUndefined (Code) , "message" :: NullOrUndefined.NullOrUndefined (Message) } ) -> ErrorDetails
...
--   This may be useful if you need to immediately overwrite some of the optional values
newExecutionDetails' :: ( { "summary" :: NullOrUndefined.NullOrUndefined (ExecutionSummary) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) , "percentComplete" :: NullOrUndefined.NullOrUndefined (Percentage) } -> {"summary" :: NullOrUndefined.NullOrUndefined (ExecutionSummary) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) , "percentComplete" :: NullOrUndefined.NullOrUndefined (Percentage) } ) -> ExecutionDetails
...
--   This may be useful if you need to immediately overwrite some of the optional values
newFailureDetails' :: Message -> FailureType -> ( { "type" :: (FailureType) , "message" :: (Message) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) } -> {"type" :: (FailureType) , "message" :: (Message) , "externalExecutionId" :: NullOrUndefined.NullOrUndefined (ExecutionId) } ) -> FailureDetails
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobDetailsOutput' :: ( { "jobDetails" :: NullOrUndefined.NullOrUndefined (JobDetails) } -> {"jobDetails" :: NullOrUndefined.NullOrUndefined (JobDetails) } ) -> GetJobDetailsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPipelineExecutionOutput' :: ( { "pipelineExecution" :: NullOrUndefined.NullOrUndefined (PipelineExecution) } -> {"pipelineExecution" :: NullOrUndefined.NullOrUndefined (PipelineExecution) } ) -> GetPipelineExecutionOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPipelineInput' :: PipelineName -> ( { "name" :: (PipelineName) , "version" :: NullOrUndefined.NullOrUndefined (PipelineVersion) } -> {"name" :: (PipelineName) , "version" :: NullOrUndefined.NullOrUndefined (PipelineVersion) } ) -> GetPipelineInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPipelineOutput' :: ( { "pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) , "metadata" :: NullOrUndefined.NullOrUndefined (PipelineMetadata) } -> {"pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) , "metadata" :: NullOrUndefined.NullOrUndefined (PipelineMetadata) } ) -> GetPipelineOutput
...
newtype GetPipelineStateOutput = GetPipelineStateOutput 
  ...
  , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  }
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPipelineStateOutput' :: ( { "pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "pipelineVersion" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "stageStates" :: NullOrUndefined.NullOrUndefined (StageStateList) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "pipelineVersion" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "stageStates" :: NullOrUndefined.NullOrUndefined (StageStateList) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> GetPipelineStateOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetThirdPartyJobDetailsOutput' :: ( { "jobDetails" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobDetails) } -> {"jobDetails" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobDetails) } ) -> GetThirdPartyJobDetailsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJob' :: ( { "id" :: NullOrUndefined.NullOrUndefined (JobId) , "data" :: NullOrUndefined.NullOrUndefined (JobData) , "nonce" :: NullOrUndefined.NullOrUndefined (Nonce) , "accountId" :: NullOrUndefined.NullOrUndefined (AccountId) } -> {"id" :: NullOrUndefined.NullOrUndefined (JobId) , "data" :: NullOrUndefined.NullOrUndefined (JobData) , "nonce" :: NullOrUndefined.NullOrUndefined (Nonce) , "accountId" :: NullOrUndefined.NullOrUndefined (AccountId) } ) -> Job
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobData' :: ( { "actionTypeId" :: NullOrUndefined.NullOrUndefined (ActionTypeId) , "actionConfiguration" :: NullOrUndefined.NullOrUndefined (ActionConfiguration) , "pipelineContext" :: NullOrUndefined.NullOrUndefined (PipelineContext) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "artifactCredentials" :: NullOrUndefined.NullOrUndefined (AWSSessionCredentials) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } -> {"actionTypeId" :: NullOrUndefined.NullOrUndefined (ActionTypeId) , "actionConfiguration" :: NullOrUndefined.NullOrUndefined (ActionConfiguration) , "pipelineContext" :: NullOrUndefined.NullOrUndefined (PipelineContext) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "artifactCredentials" :: NullOrUndefined.NullOrUndefined (AWSSessionCredentials) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } ) -> JobData
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobDetails' :: ( { "id" :: NullOrUndefined.NullOrUndefined (JobId) , "data" :: NullOrUndefined.NullOrUndefined (JobData) , "accountId" :: NullOrUndefined.NullOrUndefined (AccountId) } -> {"id" :: NullOrUndefined.NullOrUndefined (JobId) , "data" :: NullOrUndefined.NullOrUndefined (JobData) , "accountId" :: NullOrUndefined.NullOrUndefined (AccountId) } ) -> JobDetails
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListActionTypesInput' :: ( { "actionOwnerFilter" :: NullOrUndefined.NullOrUndefined (ActionOwner) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"actionOwnerFilter" :: NullOrUndefined.NullOrUndefined (ActionOwner) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListActionTypesInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListActionTypesOutput' :: ActionTypeList -> ( { "actionTypes" :: (ActionTypeList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"actionTypes" :: (ActionTypeList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListActionTypesOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPipelineExecutionsInput' :: PipelineName -> ( { "pipelineName" :: (PipelineName) , "maxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"pipelineName" :: (PipelineName) , "maxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListPipelineExecutionsInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPipelineExecutionsOutput' :: ( { "pipelineExecutionSummaries" :: NullOrUndefined.NullOrUndefined (PipelineExecutionSummaryList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"pipelineExecutionSummaries" :: NullOrUndefined.NullOrUndefined (PipelineExecutionSummaryList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListPipelineExecutionsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPipelinesInput' :: ( { "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListPipelinesInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPipelinesOutput' :: ( { "pipelines" :: NullOrUndefined.NullOrUndefined (PipelineList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"pipelines" :: NullOrUndefined.NullOrUndefined (PipelineList) , "nextToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListPipelinesOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPipelineContext' :: ( { "pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "stage" :: NullOrUndefined.NullOrUndefined (StageContext) , "action" :: NullOrUndefined.NullOrUndefined (ActionContext) } -> {"pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "stage" :: NullOrUndefined.NullOrUndefined (StageContext) , "action" :: NullOrUndefined.NullOrUndefined (ActionContext) } ) -> PipelineContext
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPipelineExecution' :: ( { "pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "pipelineVersion" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) , "status" :: NullOrUndefined.NullOrUndefined (PipelineExecutionStatus) , "artifactRevisions" :: NullOrUndefined.NullOrUndefined (ArtifactRevisionList) } -> {"pipelineName" :: NullOrUndefined.NullOrUndefined (PipelineName) , "pipelineVersion" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) , "status" :: NullOrUndefined.NullOrUndefined (PipelineExecutionStatus) , "artifactRevisions" :: NullOrUndefined.NullOrUndefined (ArtifactRevisionList) } ) -> PipelineExecution
...
newtype PipelineExecutionSummary = PipelineExecutionSummary 
  ...
  , "lastUpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  }
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPipelineExecutionSummary' :: ( { "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) , "status" :: NullOrUndefined.NullOrUndefined (PipelineExecutionStatus) , "startTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "lastUpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) , "status" :: NullOrUndefined.NullOrUndefined (PipelineExecutionStatus) , "startTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "lastUpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> PipelineExecutionSummary
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPipelineMetadata' :: ( { "pipelineArn" :: NullOrUndefined.NullOrUndefined (PipelineArn) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"pipelineArn" :: NullOrUndefined.NullOrUndefined (PipelineArn) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> PipelineMetadata
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPipelineSummary' :: ( { "name" :: NullOrUndefined.NullOrUndefined (PipelineName) , "version" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"name" :: NullOrUndefined.NullOrUndefined (PipelineName) , "version" :: NullOrUndefined.NullOrUndefined (PipelineVersion) , "created" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "updated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> PipelineSummary
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPollForJobsInput' :: ActionTypeId -> ( { "actionTypeId" :: (ActionTypeId) , "maxBatchSize" :: NullOrUndefined.NullOrUndefined (MaxBatchSize) , "queryParam" :: NullOrUndefined.NullOrUndefined (QueryParamMap) } -> {"actionTypeId" :: (ActionTypeId) , "maxBatchSize" :: NullOrUndefined.NullOrUndefined (MaxBatchSize) , "queryParam" :: NullOrUndefined.NullOrUndefined (QueryParamMap) } ) -> PollForJobsInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPollForJobsOutput' :: ( { "jobs" :: NullOrUndefined.NullOrUndefined (JobList) } -> {"jobs" :: NullOrUndefined.NullOrUndefined (JobList) } ) -> PollForJobsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPollForThirdPartyJobsInput' :: ActionTypeId -> ( { "actionTypeId" :: (ActionTypeId) , "maxBatchSize" :: NullOrUndefined.NullOrUndefined (MaxBatchSize) } -> {"actionTypeId" :: (ActionTypeId) , "maxBatchSize" :: NullOrUndefined.NullOrUndefined (MaxBatchSize) } ) -> PollForThirdPartyJobsInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPollForThirdPartyJobsOutput' :: ( { "jobs" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobList) } -> {"jobs" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobList) } ) -> PollForThirdPartyJobsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutActionRevisionOutput' :: ( { "newRevision" :: NullOrUndefined.NullOrUndefined (Boolean) , "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } -> {"newRevision" :: NullOrUndefined.NullOrUndefined (Boolean) , "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } ) -> PutActionRevisionOutput
...
newtype PutApprovalResultOutput = PutApprovalResultOutput 
  { "approvedAt" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  }
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutApprovalResultOutput' :: ( { "approvedAt" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"approvedAt" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> PutApprovalResultOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutJobSuccessResultInput' :: JobId -> ( { "jobId" :: (JobId) , "currentRevision" :: NullOrUndefined.NullOrUndefined (CurrentRevision) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "executionDetails" :: NullOrUndefined.NullOrUndefined (ExecutionDetails) } -> {"jobId" :: (JobId) , "currentRevision" :: NullOrUndefined.NullOrUndefined (CurrentRevision) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "executionDetails" :: NullOrUndefined.NullOrUndefined (ExecutionDetails) } ) -> PutJobSuccessResultInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutThirdPartyJobSuccessResultInput' :: ClientToken -> ThirdPartyJobId -> ( { "jobId" :: (ThirdPartyJobId) , "clientToken" :: (ClientToken) , "currentRevision" :: NullOrUndefined.NullOrUndefined (CurrentRevision) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "executionDetails" :: NullOrUndefined.NullOrUndefined (ExecutionDetails) } -> {"jobId" :: (ThirdPartyJobId) , "clientToken" :: (ClientToken) , "currentRevision" :: NullOrUndefined.NullOrUndefined (CurrentRevision) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "executionDetails" :: NullOrUndefined.NullOrUndefined (ExecutionDetails) } ) -> PutThirdPartyJobSuccessResultInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRetryStageExecutionOutput' :: ( { "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } -> {"pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } ) -> RetryStageExecutionOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStageContext' :: ( { "name" :: NullOrUndefined.NullOrUndefined (StageName) } -> {"name" :: NullOrUndefined.NullOrUndefined (StageName) } ) -> StageContext
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStageDeclaration' :: StageActionDeclarationList -> StageName -> ( { "name" :: (StageName) , "blockers" :: NullOrUndefined.NullOrUndefined (StageBlockerDeclarationList) , "actions" :: (StageActionDeclarationList) } -> {"name" :: (StageName) , "blockers" :: NullOrUndefined.NullOrUndefined (StageBlockerDeclarationList) , "actions" :: (StageActionDeclarationList) } ) -> StageDeclaration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStageState' :: ( { "stageName" :: NullOrUndefined.NullOrUndefined (StageName) , "inboundTransitionState" :: NullOrUndefined.NullOrUndefined (TransitionState) , "actionStates" :: NullOrUndefined.NullOrUndefined (ActionStateList) , "latestExecution" :: NullOrUndefined.NullOrUndefined (StageExecution) } -> {"stageName" :: NullOrUndefined.NullOrUndefined (StageName) , "inboundTransitionState" :: NullOrUndefined.NullOrUndefined (TransitionState) , "actionStates" :: NullOrUndefined.NullOrUndefined (ActionStateList) , "latestExecution" :: NullOrUndefined.NullOrUndefined (StageExecution) } ) -> StageState
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStartPipelineExecutionOutput' :: ( { "pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } -> {"pipelineExecutionId" :: NullOrUndefined.NullOrUndefined (PipelineExecutionId) } ) -> StartPipelineExecutionOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newThirdPartyJob' :: ( { "clientId" :: NullOrUndefined.NullOrUndefined (ClientId) , "jobId" :: NullOrUndefined.NullOrUndefined (JobId) } -> {"clientId" :: NullOrUndefined.NullOrUndefined (ClientId) , "jobId" :: NullOrUndefined.NullOrUndefined (JobId) } ) -> ThirdPartyJob
...
--   This may be useful if you need to immediately overwrite some of the optional values
newThirdPartyJobData' :: ( { "actionTypeId" :: NullOrUndefined.NullOrUndefined (ActionTypeId) , "actionConfiguration" :: NullOrUndefined.NullOrUndefined (ActionConfiguration) , "pipelineContext" :: NullOrUndefined.NullOrUndefined (PipelineContext) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "artifactCredentials" :: NullOrUndefined.NullOrUndefined (AWSSessionCredentials) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } -> {"actionTypeId" :: NullOrUndefined.NullOrUndefined (ActionTypeId) , "actionConfiguration" :: NullOrUndefined.NullOrUndefined (ActionConfiguration) , "pipelineContext" :: NullOrUndefined.NullOrUndefined (PipelineContext) , "inputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "outputArtifacts" :: NullOrUndefined.NullOrUndefined (ArtifactList) , "artifactCredentials" :: NullOrUndefined.NullOrUndefined (AWSSessionCredentials) , "continuationToken" :: NullOrUndefined.NullOrUndefined (ContinuationToken) , "encryptionKey" :: NullOrUndefined.NullOrUndefined (EncryptionKey) } ) -> ThirdPartyJobData
...
--   This may be useful if you need to immediately overwrite some of the optional values
newThirdPartyJobDetails' :: ( { "id" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobId) , "data" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobData) , "nonce" :: NullOrUndefined.NullOrUndefined (Nonce) } -> {"id" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobId) , "data" :: NullOrUndefined.NullOrUndefined (ThirdPartyJobData) , "nonce" :: NullOrUndefined.NullOrUndefined (Nonce) } ) -> ThirdPartyJobDetails
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTransitionState' :: ( { "enabled" :: NullOrUndefined.NullOrUndefined (Enabled) , "lastChangedBy" :: NullOrUndefined.NullOrUndefined (LastChangedBy) , "lastChangedAt" :: NullOrUndefined.NullOrUndefined (LastChangedAt) , "disabledReason" :: NullOrUndefined.NullOrUndefined (DisabledReason) } -> {"enabled" :: NullOrUndefined.NullOrUndefined (Enabled) , "lastChangedBy" :: NullOrUndefined.NullOrUndefined (LastChangedBy) , "lastChangedAt" :: NullOrUndefined.NullOrUndefined (LastChangedAt) , "disabledReason" :: NullOrUndefined.NullOrUndefined (DisabledReason) } ) -> TransitionState
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdatePipelineOutput' :: ( { "pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) } -> {"pipeline" :: NullOrUndefined.NullOrUndefined (PipelineDeclaration) } ) -> UpdatePipelineOutput
